...
export const DICT = {
  en: {
    ...
    'you.exportCopied': 'Export copied to the clipboard. Paste it somewhere safe.',
    'you.exportFailed': 'Export needs a browser tab. Open the site in Chrome or Safari.',
  ...
  ar: {
    ...
    'you.exportCopied': 'تم نسخ النسخة إلى الحافظة. الصقها في مكان آمن.',
    'you.exportFailed': 'التصدير يحتاج متصفحًا. افتح الموقع في كروم أو سفاري.',
